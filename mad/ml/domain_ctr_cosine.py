...
from mad.ml import distances, distances_maha_ctr, distances_cosine_ctr
...
class dist_func_model_maha_ctr:

    def train(self, X, y=None):
        self.dist_func = lambda x: distances_maha_ctr.distance(X, x, y)
