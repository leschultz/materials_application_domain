...
class MyTokenEmbedding(nn.Module):
    def __init__(self, emb, l2norm_embed = False):
        super().__init__()
        self.l2norm_embed = l2norm_embed
        self.emb = emb
    ...
    def forward(self, x):
        try:
            ...
            assert False, f"Problematic index: {x}"
        return l2norm(token_emb) if self.l2norm_embed else token_emb    
...
class TransformerWrapper(nn.Module):
    def __init__(
        ...
        *,
        ...
        tie_embedding = False,
        use_abs_pos_emb = False, # I don't want to have any positional embedding
        l2norm_embed = False,
        my_embedder = None
    ):
        super().__init__()
        ...
        self.l2norm_embed = l2norm_embed
        self.token_emb = MyTokenEmbedding(my_embedder)
    ...
    def forward(
        ...
        **kwargs
        ...
        x = self.token_emb(x) + pos_emb # pos_emb should always be 0
        assert pos_emb == 0, "Find pos_emb isn't 0! I don't want to have pos emb\n"
